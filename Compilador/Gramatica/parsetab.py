...
_lr_productions = [
  ...
  ('init -> ls_instr','init',1,'p_init','gramatica.py',159),
  ('init -> empty','init',1,'p_init_empty','gramatica.py',163),
  ('empty -> <empty>','empty',0,'p_empty','gramatica.py',167),
  ('ls_instr -> ls_instr instr','ls_instr',2,'p_ls_instr','gramatica.py',171),
  ('ls_instr -> instr','ls_instr',1,'p_ls_instr2','gramatica.py',176),
  ('instr -> instruccion','instr',1,'p_instr_recib','gramatica.py',180),
  ...
  ('instrucciones -> instrucciones instruccion','instrucciones',2,'p_instrucciones_instrucciones_instruccion','gramatica.py',204),
  ('instrucciones -> instruccion','instrucciones',1,'p_instrucciones_instruccion','gramatica.py',210),
  ('instruccion -> imprimir_instr','instruccion',1,'p_instruccion','gramatica.py',218),
  ('imprimir_instr -> RPRINT PARA PARAMETROS PARC','imprimir_instr',4,'p_imprimir','gramatica.py',224),
  ('expresion -> expresion MAS expresion','expresion',3,'p_aritmeticas','gramatica.py',229),
  ('expresion -> expresion MENOS expresion','expresion',3,'p_aritmeticas','gramatica.py',230),
  ('expresion -> expresion MULTIPLICACION expresion','expresion',3,'p_aritmeticas','gramatica.py',231),
  ('expresion -> expresion DIVISION expresion','expresion',3,'p_aritmeticas','gramatica.py',232),
  ('expresion -> expresion POTENCIA expresion','expresion',3,'p_aritmeticas','gramatica.py',233),
  ('expresion -> expresion MODULO expresion','expresion',3,'p_aritmeticas','gramatica.py',234),
  ('expresion -> expresion MAYORQUE expresion','expresion',3,'p_relacionales','gramatica.py',251),
  ('expresion -> expresion MENORQUE expresion','expresion',3,'p_relacionales','gramatica.py',252),
  ('expresion -> expresion MAYORIGUAL expresion','expresion',3,'p_relacionales','gramatica.py',253),
  ('expresion -> expresion MENORIGUAL expresion','expresion',3,'p_relacionales','gramatica.py',254),
  ('expresion -> expresion IGUALIGUAL expresion','expresion',3,'p_relacionales','gramatica.py',255),
  ('expresion -> expresion DIFERENTE expresion','expresion',3,'p_relacionales','gramatica.py',256),
  ('expresion -> expresion RAND expresion','expresion',3,'p_logicas','gramatica.py',275),
  ('expresion -> expresion ROR expresion','expresion',3,'p_logicas','gramatica.py',276),
  ('expresion -> RNOT expresion','expresion',2,'p_expre_not','gramatica.py',279),
  ('expresion -> MENOS expresion','expresion',2,'p_negacion','gramatica.py',282),
  ('expresion -> PARA expresion PARC','expresion',3,'p_parentesis','gramatica.py',286),
  ...
  ('expresion -> ID','expresion',1,'p_expresion_id','gramatica.py',303),
  ('expresion -> RTRUE','expresion',1,'p_expresion_bool','gramatica.py',307),
  ('expresion -> RFALSE','expresion',1,'p_expresion_bool','gramatica.py',308),
  ('expresion -> RNULO','expresion',1,'p_expresion_bool','gramatica.py',309),
]
